...
database of more than 2400 non-coding RNAs \\ each represented by a
...
\begin{slide}
\begin{center}
\textbf{TODO: Latest improvements in Infernal} \\

\small
\begin{itemize}
\item Version 1.1.2 of Infernal was released in July, 2016
\item New features are in the \texttt{cmscan} program: 
\item Significantly faster on large datasets due saving models instead
  of re-reading them for each sequence
\item Annotates overlapping hits 
\end{itemize}
