...
\scriptsize
\begin{itemize}
\item example searches: bacterial genome; 1K metagenomic reads
\end{itemize}
...
\begin{slide}
\begin{center}
\textbf{cmscan faster and annotates overlapping hits} \\

\begin{itemize}
\item CPU=0 running times
\item multithreaded running times
\end{itemize}
